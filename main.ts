...
namespace OLED {
    ...
    //% block="Return to OLED display origin"
    //% weight=3
    ...
    //% block="Move OLED display cursor to $coorX and $coorY"
    //% weight=3
    export function moveCursor(coorX: number, coorY: number) {
        charX = coorX
        charY = coorY
    }
    ...
    export function init(width: number, height: number) {
        ...
        command(0xF0);                                  // the suggested ratio 0x80
